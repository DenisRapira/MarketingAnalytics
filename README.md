...
![Сценарий работы](docs/screenshots/MarketingHealth.png)
...
Исходный код и официальные сборки распространяются по [Apache License 2.0](LICENSE). Лицензия разрешает использование, изменение и распространение при сохранении условий и уведомлений лицензии.
